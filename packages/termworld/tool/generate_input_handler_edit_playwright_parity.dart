...
''');
  for (final entry in cases) {
    ...
    source
      ...
      ..writeln('    () => verifyInputHandlerEditPlaywrightCase(');
  ...
  source.writeln('}');
  File(
    '${package.path}/test/upstream_input_handler_edit_playwright_parity_test.dart',
  ...
  for (final entry in cases) {
    ...
    additions
      ...
      ..write(
        '"dartTestFile":'
        '"test/upstream_input_handler_edit_playwright_parity_test.dart",',
      )
      ..write(
